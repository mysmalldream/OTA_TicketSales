    ...
    <div>
        ...
        <div class="form-box">
            <el-form ref="form" :model="form" label-width="120px">
                ...
                <el-form-item label="优先级类别" prop="priorityType">
                ...
                <el-form-item label="分销商列表" prop="customName">
                    <el-select v-model="form.customName" multiple placeholder="请选择" @change="handleChange6">
                        <el-option v-for="item in custom" :key="item.id" :label="item" :value="item"></el-option>
                    </el-select>
                </el-form-item>
    ...
    methods: {
        ...
        onSubmit(formName) {
            ...
            this.$refs[formName].validate((valid) => {
                if (valid) {
                    axios.post(common.apidomain + "/product/add.action?name=" + this.form.name + "&viewName=" + this.form.viewName + "&supplierName=" + this.form.supplierName + "&endPrice=" + this.form.endPrice + "&marketPrice=" + this.form.marketPrice + "&type=" + this.form.type + "&ticketType=" + this.form.ticketType + "&startTime=" + this.form.startTime + "&endTime=" + this.form.endTime + "&dailySale=" + this.form.dailySale + "&num=" + this.form.num + "&orderTime=" + this.form.orderTime + "&notice=" + this.form.notice + "&costInside=" + this.form.costInside + "&costOutside=" + this.form.costOutside + "&remark=" + this.form.remark + "&userType=" + this.form.userType + "&priorityId=" + this.form.priorityId + "&customPro=" + this.customer + "&isSale=" + this.form.isSale + "&isCancel=" + this.form.isCancel + "&viewId=" + this.form.viewId + "&supplierId=" + this.form.supplierId + "&method=" + this.form.method).then((res) => {
                        console.log(res.data)
