...
export default {
    ...
    methods: {
        ...
        onSubmit() {
            ...
            axios.get(common.apidomain + "/order/stateOerder.action?startTime=" + this.form.startTime + '&startTimeEnd=' + this.form.startTimeEnd+ '&endTime=' + this.form.endTime+ '&endTimeEnd=' + this.form.endTimeEnd +"&state=1"+"&power_id="+JSON.parse(window.sessionStorage.getItem("powerId"))+"&staff_id="+JSON.parse(window.sessionStorage.getItem("id")) + '&pageIndex=' + this.pagingNowNumberList).then((res) => {
        ...
        handleCurrentChange(val) {
            // console.log(`当前页: ${val}`);
            axios.get(common.apidomain + "/order/stateOerder.action?pageIndex=" + `${val}` + "&startTime=" + this.form.startTime+ "&startTimeEnd=" + this.form.startTimeEnd + '&endTime=' + this.form.endTime+ '&endTimeEnd=' + this.form.endTimeEnd +"&state=1"+"&power_id="+JSON.parse(window.sessionStorage.getItem("powerId"))+"&staff_id="+JSON.parse(window.sessionStorage.getItem("id"))).then((res) => {
