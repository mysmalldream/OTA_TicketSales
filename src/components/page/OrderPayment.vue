...
export default {
    ...
    methods: {
        ...
        onSubmit() {
            ...
            axios.get(common.apidomain + "/order/stateOerder.action?startTime=" + this.form.startTime + '&endTime=' + this.form.endTime +"&state=1"+"&power_id="+JSON.parse(window.sessionStorage.getItem("powerId"))+"&staff_id="+JSON.parse(window.sessionStorage.getItem("id")) + '&pageIndex=' + this.pagingNowNumberList).then((res) => {
        ...
        //数据的初次加载
        getimgs() {
            axios.get(common.apidomain + "/order/stateOerder.action?pageIndex=" + this.pagingNowNumberList+"&state=1"+"&power_id="+JSON.parse(window.sessionStorage.getItem("powerId"))+"&staff_id="+JSON.parse(window.sessionStorage.getItem("id"))).then((res) => {
                console.log(res.data);
                this.tableData = res.data.data.datas;   //表格数据
                this.total = res.data.data.allCount;    //条数
                this.pageCount = res.data.data.pageCount;   //总的页码数
        ...
        handleCurrentChange(val) {
            // console.log(`当前页: ${val}`);
            axios.get(common.apidomain + "/order/stateOerder.action?pageIndex=" + `${val}` + "&startTime=" + this.form.startTime + '&endTime=' + this.form.endTime +"&state=1"+"&power_id="+JSON.parse(window.sessionStorage.getItem("powerId"))+"&staff_id="+JSON.parse(window.sessionStorage.getItem("id"))).then((res) => {
