    ...
    <div>
        ...
        <form id="forms" action=""  method="post" enctype="multipart/form-data" >
            ...
            <label for="dizhi"><span>* </span> 景区位置:</label> <el-tag type="success">[★小贴士★]输入景区名称或拖动地图以选择景区位置~</el-tag>
                <div class="map">
                    <div>
                        <b>经度：</b><input type="text" name="lng"  id="lng" disabled value="0" required="required"/><b>纬度：</b><input type="text" name="lat" id="lat" disabled value="0" required="required"/>
                    </div>
                </div>
                        <div><b>详细地址:</b><span>1</span>{{ dragData.address }}</div>
                <div class="m-part">
